...
describe('*********** PROFILE ***********', () => {
  ...
  describe('/PATCH profile', () => {
    ...
    it('it should UPDATE profile', (done) => {
      const user = {
        name: 'Test123456',
        url_twitter: 'https://hello.com',
        url_github: 'https://hello.io',
        phone: '123123123',
        city: 'Bucaramanga',
        country: 'Colombia',
      };
      chai
        ...
        .end((err, res) => {
          ...
          res.body.should.have.property('url_twitter').eql('https://hello.com');
          res.body.should.have.property('url_github').eql('https://hello.io');
